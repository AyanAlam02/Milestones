document.addEventListener("DOMContentLoaded", () => {
  ...
  const shareLinkContainer = document.getElementById("shareLinkContainer") as HTMLParagraphElement;
  ...
  form.addEventListener("submit", (event) => {
    ...
    const uniqueUrl = `https://${name.replace(/\s+/g, "").toLowerCase()}.vercel.app/resume`;
