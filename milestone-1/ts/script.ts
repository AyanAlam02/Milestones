...
const toggleProjectsBtn = document.getElementById(
  "toggleProjects"
) as HTMLButtonElement;
const toggleSkillsBtn = document.getElementById(
  "toggleSkills"
) as HTMLButtonElement;
const toggleExperienceBtn = document.getElementById(
  "toggleExperience"
) as HTMLButtonElement;
const togglePersonalInfoBtn = document.getElementById(
  "togglePersonalInfo"
) as HTMLButtonElement;
const toggleEducationBtn = document.getElementById(
  "toggleEducation"
) as HTMLButtonElement;
